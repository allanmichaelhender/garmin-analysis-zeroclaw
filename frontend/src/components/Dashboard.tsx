  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-6xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Garmin Analysis Dashboard</h1>
        
        {/* Stats Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-700">Total Activities</h3>
            <p className="text-3xl font-bold text-blue-600 mt-2">{totalActivities}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-700">Total Distance</h3>
            <p className="text-3xl font-bold text-green-600 mt-2">{totalDistance.toFixed(1)} km</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold text-gray-700">Avg Heart Rate</h3>
            <p className="text-3xl font-bold text-red-600 mt-2">{avgHR} bpm</p>
          </div>
        </div>
              ...
              <div key={activity.id} className="border-b pb-4 last:border-0">
                <div className="flex justify-between items-start">
                  ...
                  <div className="text-right">
                    <p className="font-semibold text-gray-900">{(activity.distance / 1000).toFixed(1)} km</p>
                    <p className="text-sm text-gray-600">{Math.floor(activity.duration / 60)} min</p>
                  </div>
                </div>
